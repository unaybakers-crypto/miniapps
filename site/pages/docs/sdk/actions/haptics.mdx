...
await sdk.actions.haptics.impactOccurred('medium')

// Trigger notification feedback
await sdk.actions.haptics.notificationOccurred('success')

// Trigger selection feedback
await sdk.actions.haptics.selectionChanged()
```
...
await sdk.actions.haptics.impactOccurred('light')

// Trigger for more significant actions
await sdk.actions.haptics.impactOccurred('heavy')
```
...
await sdk.actions.haptics.notificationOccurred('warning')

// On error
await sdk.actions.haptics.notificationOccurred('error')
```
...
Haptic feedback availability depends on the client device and platform. You can check if haptics are supported using the context:
