...
Details about features supported by the client. This allows apps to conditionally
use features based on client capabilities.
...
- `haptics`: whether the client supports haptic feedback
...
// Check if haptics are supported before using
