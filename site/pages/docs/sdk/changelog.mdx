...
- Added [`haptics`](/docs/sdk/actions/haptics) actions for triggering haptic feedback (impact, notification, and selection)
- Added `features` field to [context](/docs/sdk/context) for detecting client capabilities like haptic support
