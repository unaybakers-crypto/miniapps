...
- Added `cast_share` location type for [share
extensions](/docs/concepts/share-extensions), enabling Mini Apps to receive shared casts from the system share sheet
