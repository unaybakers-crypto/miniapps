...
you'll want to choose a stable domain. There's no limit on the number of apps
...
Tool](https://warpcast.com/~/developers/mini-apps/manifest) in Warpcast. 
...
In a nutshell, Mini Apps:
- are web apps
- are idenitified by the domain they are hosted on
- are owned by a single Farcaster Account 
- are published by hosting a `/.well-known/farcaster.json` file

## Next Steps

Congratulations—you've published your Mini App! Before you start sharing your
app with users you'll want to:
- [make your app sharable in feeds](/docs/guides/sharing)
- [setup webhooks if you want to send notifications](/docs/guides/notifications)
