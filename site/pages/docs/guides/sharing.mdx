...
Learn how to obtain the Universal Links and how they work in the [Mini App URLs](/docs/concepts/universal-links) guide.
...
## Extending the share sheet

In addition to sharing your Mini App through embeds, your app can also receive
casts that users share to it through the system share sheet by setting up a
[Share Extension](/docs/concepts/share-extensions).
