...
To make the animation smooth it's generally recommended to wait until all the
elements in your interface are loaded before calling ready. This will avoid a
jarring effect where the user sees a cascade of loading screens.
