...
- [isInMiniApp](/docs/sdk/is-in-mini-app) - Check if the Mini App is running in a Mini App context
- [setShareStateProvider](/docs/sdk/set-share-state-provider) - Set the share state that will be used when the Mini App is shared.
